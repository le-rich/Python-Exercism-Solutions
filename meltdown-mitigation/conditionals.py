...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    percentageValue = (generated / theoretical_max_power) * 100
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    tempNeutronsPerS = temperature * neutrons_produced_per_second
    if tempNeutronsPerS < (0.90 * threshold):
        return 'LOW'
    elif tempNeutronsPerS <= (1.10 * threshold) and tempNeutronsPerS >= (0.90 * threshold):
        return 'NORMAL'
    else:
        return 'DANGER'